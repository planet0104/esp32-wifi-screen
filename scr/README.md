...
4. **配置项目**
   ...
   基于 ESP32-S2/S3 的 WiFi 显示屏项目，支持通过 HTTP/WebSocket/MQTT 远程控制 TFT 显示屏。
   ...
   > 注意：本项目固定使用 ESP-IDF v5.3.4。也可以使用仓库提供的构建脚本（`build_esp32s2.ps1` / `build_esp32s3.ps1`）来自动设置这些变量。
