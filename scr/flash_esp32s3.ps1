...
Write-Host "Flashing merged image for ESP32-S3..." -ForegroundColor Green
...
if (-not (Test-Path $binOutputPath)) {
    ...
    Write-Host "Run build_esp32s3.ps1 first to generate the merged image." -ForegroundColor Yellow
    exit 1
}
